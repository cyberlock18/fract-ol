...
=======
/*   Updated: 2025/01/29 23:47:55 by ruortiz-         ###   ########.fr       */
...
<<<<<<< HEAD
	...
	int		max_iter;
=======
	double	z_re;  // Añadir para el suavizado de color
	double	z_im;  // Añadir para el suavizado de color
>>>>>>> 2e72583 (optimizacion de archivos)
}	t_data;
...
// Prototipos para los esquemas de color
